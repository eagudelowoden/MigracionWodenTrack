...
export class ReportsService {
  ...
  async generarPlantillaMallas(
    ...
    worksheet.columns = [
      ...
      { header: 'nombre_malla', key: 'nombre_malla', width: 40 },
    ];
  ...
  async generarReporteAsistencias(data: any[]): Promise<Buffer> {
    ...
    worksheet.columns = [
      ...
      { header: 'ENTRADA (DD/MM/AAAA   HH:MM:SS)', key: 'entrada', width: 30 },
      { header: 'SALIDA (DD/MM/AAAA   HH:MM:SS)', key: 'salida', width: 30 },
