...
async function main() {
  ...
  try {
    ...
    // son del socket (DNS, resolución lenta) y garantiza que el script termine
    // muy por debajo del command_timeout del pipeline.
    ...
    // Cierra el socket del SMTP: si queda abierto, el proceso no termina y el
    // paso se cuelga igual aunque el correo sí se haya enviado.
