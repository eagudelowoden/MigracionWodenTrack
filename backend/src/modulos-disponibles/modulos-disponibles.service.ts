...
const SEED_DATA: Omit<ModuloDisponible, 'id' | 'fecha_creacion'>[] = [
  ...
  { slug: 'super.datoscrudos', nombre: 'Datos Crudos', descripcion: 'Diagnóstico de registros crudos de Odoo (hr.attendance / attendance.log), sin cruzar mallas ni cédulas', grupo: 'super', grupo_label: 'Super Admin', grupo_icon: 'fas fa-shield-halved', orden: 18, activo: true, es_scope: false, es_base: false, creado_por: 'sistema' },
  // ── Panel Admin ──────────────────────────────────────────────────────────────
  ...
  { slug: 'admin.marcacion', nombre: 'Marcación de Asistencia', descripcion: 'Vista de marcación de asistencias y confirmación de entrada/salida', grupo: 'admin', grupo_label: 'Panel Admin', grupo_icon: 'fas fa-user-shield', orden: 1.5, activo: true, es_scope: false, es_base: true, creado_por: 'sistema' },
  { slug: 'admin.marcacion_seriales', nombre: 'Seriales Recuperados', descripcion: 'Consulta de seriales recuperados en el sistema Woden FSM', grupo: 'admin', grupo_label: 'Panel Admin', grupo_icon: 'fas fa-user-shield', orden: 1.6, activo: true, es_scope: false, es_base: true, creado_por: 'sistema' },
  ...
  { slug: 'admin.dashboard_asistencia', nombre: 'Dashboard de Asistencia', descripcion: 'Ranking de tardanzas, comparativo de cumplimiento por área y tendencia mensual', grupo: 'admin', grupo_label: 'Panel Admin', grupo_icon: 'fas fa-user-shield', orden: 4, activo: true, es_scope: false, es_base: true, creado_por: 'sistema' },
  // ── Gestión de Horas ─────────────────────────────────────────────────────────
  ...
  { slug: 'admin.ver_todo', nombre: 'Ver Todos los Departamentos', descripcion: 'Ve todos los departamentos y empleados de su empresa/país sin restricción de área o segmento', grupo: 'scope', grupo_label: 'Alcance de visibilidad', grupo_icon: 'fas fa-eye', orden: 5, activo: true, es_scope: true, es_base: true, creado_por: 'sistema' },
  // ── Novedades ────────────────────────────────────────────────────────────────
