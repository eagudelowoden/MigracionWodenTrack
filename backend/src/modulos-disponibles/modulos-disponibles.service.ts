...
const SEED_DATA: Omit<ModuloDisponible, 'id' | 'fecha_creacion'>[] = [
  ...
  { slug: 'admin.calculos', nombre: 'Horas Extra', descripcion: 'Cálculo y registro de horas extra', grupo: 'admin', grupo_label: 'Panel Admin', grupo_icon: 'fas fa-user-shield', orden: 3, activo: true, es_scope: false, es_base: true, creado_por: 'sistema' },
  { slug: 'admin.novedades', nombre: 'Novedades', descripcion: 'Acceso al módulo de novedades', grupo: 'admin', grupo_label: 'Panel Admin', grupo_icon: 'fas fa-user-shield', orden: 4, activo: true, es_scope: false, es_base: true, creado_por: 'sistema' },
  { slug: 'horas.ver_cargue_ch', nombre: 'Cargue Horas CH', descripcion: 'Visualización del cargue de horas CH', grupo: 'admin', grupo_label: 'Panel Admin', grupo_icon: 'fas fa-user-shield', orden: 5, activo: true, es_scope: false, es_base: true, creado_por: 'sistema' },
