<template>
  <div class="h-full animate-fade-in flex flex-col gap-2 font-round-custom">
      ...
      <div class="flex flex-wrap items-center gap-1.5">
        ...
        <div class="flex items-center gap-1.5 border-l pl-1.5 ml-0.5"
          ...
          <button @click="fetchMallasDesdeOdoo"
            ...
            title="Buscar">
            <i class="fas fa-magnifying-glass text-[10px]" :class="{ 'fa-spin': isLoadingMallas }"></i>
          </button>
    ...
    <MallaUploadWindow v-model="showUploadWindow" :isDark="isDark" @uploaded="fetchMallasDesdeOdoo" />
