<template>
  <div class="min-h-screen flex items-center justify-center transition-all duration-700 p-4 font-sans"
    ...
    <div class="woden-card relative" :class="isDark ? 'card-dark' : 'card-light'">
      ...
      <div
        class="absolute -top-4 -right-2 w-11 h-11 bg-gradient-to-tr from-[#ff8f00] to-[#ff4e00] rounded-2xl flex items-center justify-center shadow-xl rotate-12">
      ...
      <div>
        ...
        <div class="space-y-4">
          <div class="input-wrapper">
            <input v-model="form.usuario" type="text" placeholder="ID DE ACCESO" class="woden-input-base"
          ...
          <div class="input-wrapper">
            <input v-model="form.password" :type="showPassword ? 'text' : 'password'" placeholder="PIN DE SEGURIDAD"
              class="woden-input-base" @keyup.enter="handleLogin">
            <svg class="input-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
      ...
      <div class="mt-8">
        ...
        <div class="flex flex-col items-center gap-2">
          <button @click="toggleTheme" class="text-[10px] font-black uppercase tracking-widest transition-colors"
        ...
        <div class="flex flex-col items-center gap-2 mt-4">
          <router-link to="/download"
            class="text-[9px] font-black text-[#ff8f00] uppercase tracking-widest hover:underline">
    ...
    <transition name="toast">
      <div v-if="message.text"
        :class="message.type === 'error' ? 'border-red-500 bg-red-500/10 text-red-500' : 'border-emerald-500 bg-emerald-500/10 text-emerald-500'"
        class="fixed top-10 z-[100] px-6 py-2.5 rounded-xl border backdrop-blur-md font-bold text-[10px] flex items-center gap-3 shadow-2xl">
